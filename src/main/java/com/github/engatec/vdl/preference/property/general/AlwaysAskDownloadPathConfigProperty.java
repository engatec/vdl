...
import com.github.engatec.vdl.preference.configitem.general.AlwaysAskDownloadPathConfigItem;
import com.github.engatec.vdl.preference.property.ConfigProperty;
import javafx.beans.property.BooleanProperty;
import javafx.beans.property.SimpleBooleanProperty;

public class AlwaysAskDownloadPathConfigProperty extends ConfigProperty<BooleanProperty, Boolean> {
    ...
    public AlwaysAskDownloadPathConfigProperty() {
        restore();
    }
