...
import com.github.engatec.vdl.preference.configitem.general.LoadThumbnailsConfigItem;
import com.github.engatec.vdl.preference.property.ConfigProperty;
import javafx.beans.property.BooleanProperty;
import javafx.beans.property.SimpleBooleanProperty;

public class LoadThumbnailsConfigProperty extends ConfigProperty<BooleanProperty, Boolean> {
    ...
    public LoadThumbnailsConfigProperty() {
        restore();
    }
