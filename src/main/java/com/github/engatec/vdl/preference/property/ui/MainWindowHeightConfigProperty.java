...
import com.github.engatec.vdl.preference.configitem.ui.MainWindowHeightConfigItem;
import com.github.engatec.vdl.preference.property.ConfigProperty;
import javafx.beans.property.DoubleProperty;
import javafx.beans.property.SimpleDoubleProperty;

public class MainWindowHeightConfigProperty extends ConfigProperty<DoubleProperty, Double> {
    ...
    public MainWindowHeightConfigProperty() {
        restore();
