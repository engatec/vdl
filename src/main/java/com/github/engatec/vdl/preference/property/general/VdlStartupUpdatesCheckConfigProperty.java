...
import com.github.engatec.vdl.preference.configitem.general.VdlStartupUpdatesCheckConfigItem;
import com.github.engatec.vdl.preference.property.ConfigProperty;
import javafx.beans.property.BooleanProperty;
import javafx.beans.property.SimpleBooleanProperty;

public class VdlStartupUpdatesCheckConfigProperty extends ConfigProperty<BooleanProperty, Boolean> {
    ...
    public VdlStartupUpdatesCheckConfigProperty() {
        restore();
    }
