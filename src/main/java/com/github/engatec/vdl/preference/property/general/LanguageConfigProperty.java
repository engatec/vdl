...
import com.github.engatec.vdl.preference.configitem.general.LanguageConfigItem;
import com.github.engatec.vdl.preference.property.ConfigProperty;
import javafx.beans.property.SimpleStringProperty;
import javafx.beans.property.StringProperty;

public class LanguageConfigProperty extends ConfigProperty<StringProperty, String> {

    private static final ConfigItem<String> CONFIG_ITEM = new LanguageConfigItem();

    private final StringProperty property = new SimpleStringProperty();

    public LanguageConfigProperty() {
        restore();
    }
