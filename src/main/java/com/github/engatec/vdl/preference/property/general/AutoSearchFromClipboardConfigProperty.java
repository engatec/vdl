...
import com.github.engatec.vdl.preference.configitem.general.AutoSearchFromClipboardConfigItem;
import com.github.engatec.vdl.preference.property.ConfigProperty;
import javafx.beans.property.BooleanProperty;
import javafx.beans.property.SimpleBooleanProperty;

public class AutoSearchFromClipboardConfigProperty extends ConfigProperty<BooleanProperty, Boolean> {
    ...
    public AutoSearchFromClipboardConfigProperty() {
        restore();
    }
